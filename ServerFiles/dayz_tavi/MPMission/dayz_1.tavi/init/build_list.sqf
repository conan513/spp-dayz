...
[[0, 2, 0, 0, 0, 0], "Land_fort_bagfence_long", 	[[0,4,.3], 	[0,2,0], 	0, 	true, true, false, false, false, false, false, true, false, true, false]],//Land_fort_bagfence_long --14
...
[[2, 0, 0, 0, 0, 0], "Land_CncBlock",				[[0,3,.4], 	[0,2,0], 	0, 	true, false, false, false, false, true, true, true, false, true, false]],//Land_CncBlock --19
...
[[3, 0, 0, 0, 0, 0], "Fence_corrugated_plate",		[[0,4,.6], 	[0,3,0], 	0,	true, false, false, false, false, false, false, true, false, true, true]],//Fence_corrugated_plate --23
...
[[0, 0, 2, 0, 2, 0], "Land_CamoNet_EAST",			[[0,8,1.2], [0,7,0], 	0, 	true, false, true, false, false, false, false, true, false, true, true]],//Land_CamoNet_EAST --30
...
[[0, 0, 2, 0, 1, 0], "Fence_Ind",  					[[0,4,.7], 	[0,2,0], 	0, 	true, false, false, false, false, false, true, true, false, true, true]], //Fence_Ind 	
...
[[2, 0, 0, 0, 0, 0], "Land_CncBlock",					[[0,3,.4], 	[0,2,0], 		0, 	true, false,false, 	false, true,  true, true, true, false, true, true]],//Land_CncBlock --43
...
[[0, 0, 0, 4, 0, 0], "Land_WoodenRamp",					[[0,7,1], 	[0,3,0], 		90, true, true, true, 	false, false, false, true, true,  true,  true, true]], // Small wooden ramp
[[3, 3, 0, 1, 1, 0], "RampConcrete", 					[[0,5,.6],	[0,2,0], 		0, 	true, false,true, 	false, true,  true,  true, true,  false, true, false]], // Shallow concrete ramp
[[0, 0, 0, 2, 3, 0], "Land_Ind_TankSmall2", 			[[0,10,1], 	[0,10,0], 		0, 	true, true, false, true, false, false, false, true, false, true, false]] //Base_WarfareBBarrier10xTall --5 
]; 
