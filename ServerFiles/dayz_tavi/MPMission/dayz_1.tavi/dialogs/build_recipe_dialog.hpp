...
class Build_Recipe_Dialog
{
    ...
    class Controls
    {
        ...
        class PrevButton: RscButton
        {
            ...
            action = "_nil=[]ExecVM 'z\addons\dayz_code\buildRecipeBook\prevBuildRecipe.sqf'";
        };
        ...
        class NextButton: RscButton
        {
            ...
            w = 0.0886457 * safezoneW;
            h = 0.0521932 * safezoneH;
            action = "_nil=[]ExecVM 'z\addons\dayz_code\buildRecipeBook\nextBuildRecipe.sqf'";
        };
        class ShowButton: RscButton
        {
            ...
            action = "closeDialog 0;_nil=[]ExecVM 'z\addons\dayz_code\compile\player_build.sqf'";
        };
        class ShowListButton: RscButton
        {
            ...
            w = 0.0751041 * safezoneW;
            h = 0.051254 * safezoneH;
            action = "closeDialog 0;_nil=[]ExecVM 'z\addons\dayz_code\buildRecipeBook\build_recipe_list_dialog.sqf'";
        };
        ...
        {
            idc = 1209;
            text = "z\addons\dayz_code\buildRecipeBook\images\timer.paa";
            x = 0.409766 * safezoneW + safezoneX;
            y = 0.444989 * safezoneH + safezoneY;
            w = 0.019375 * safezoneW;
            h = 0.0315319 * safezoneH;
